...
const Banner = () => {
    return (
        <div className='relative'>
            ...
            <div className="flex gap-2 md:gap-0 justify-around items-center w-full md:w-3/4 bg-[#000080] md:h-36 rounded-xl absolute -bottom-12 md:left-32" data-aos="fade-up">
