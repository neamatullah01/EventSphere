...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-[#000080] text-primary-content" data-aos="flip-right">
            <aside>
                ...
                EventSphere Agency Ltd. <br />Providing reliable tech since 1992
                </p>
